...
const links = [
  ...
  },
  {
    ...
    items: [
      { title: "Contact", href: "/#contact" },
      { title: "GitHub", href: "https://github.com/ZB-ZettaByte/Bourse" },
      { title: "README", href: "https://github.com/ZB-ZettaByte/Bourse#readme" },
    ],
  },
  {
    group: "Explore",
...
export default function SiteFooter() {
  return (
    <footer className="relative overflow-hidden border-t border-emerald-300/15 bg-green-900 text-white">
      ...
      <div
        aria-hidden
        className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.035),transparent_38%)]"
      />
      <div
        aria-hidden
        className="footer-rocket pointer-events-none absolute bottom-10 left-6 text-emerald-300/80"
      >
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-14 md:px-8 lg:py-20">
          ...
          <div className="space-y-6 md:col-span-2">
            ...
            <div>
              ...
              <p className="mt-3 max-w-sm text-sm leading-6 text-white/50">
                A personal stock research project for exploring market movement, company context, news, and
                ...
                <div className="flex flex-wrap gap-4 sm:flex-col">
                  {group.items.map((item) => (
                    <Link
                      key={item.title}
                      href={item.href}
                      className="block text-sm font-semibold text-white/45 transition-colors hover:text-emerald-300"
                    >
                      {item.title}
                    </Link>
                  ))}
        ...
        <div className="mt-12 flex flex-col justify-between gap-3 border-t border-white/10 pt-6 text-xs font-semibold text-white/35 md:flex-row">
          <p>&copy; 2026 Bourse. Built for stock research and portfolio context. Sai Rithwik Kukunuri.</p>
